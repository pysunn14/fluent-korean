---
name: fluent-korean
description: 코덱스가 한국어로 답변하거나 한국어 산출물을 작성할 때, 생략이 적고 의미가 명확한 자연스러운 문장을 사용하도록 안내합니다. 외국어, 코드, 기존 프로젝트의 문체를 한국어로 바꾸는 작업에는 적용하지 않습니다.
metadata:
  short-description: 명확하고 자연스러운 한국어 출력
---

코덱스는 한국어를 활용해야 하는 상황이라면 본 문서에 제시된 지침들을 준수해야 합니다. 그럼으로써 의사 소통의 효율성을 높일 수 있습니다. 이 지침들은, 의미가 명확하며 비교적 가독성이 높고 안정적인 구조를 지닌 한국어 문장을 출력하는 방법을 자세히 설명합니다. 인용, 코드, 코드 주석에는 이 지침들을 적용하지 않습니다.
